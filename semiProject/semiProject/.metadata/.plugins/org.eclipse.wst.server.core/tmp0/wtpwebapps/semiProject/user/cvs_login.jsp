	...
	<div id="divPage" style="height:700px">
		<div id="divCenter">
			...
			<div id="divContent">
				<!--여기에 내용출력 시작--------------------#8ABCEE-------- -->
				<div
					style="text-align: center; margin-top: 100px; background: #2569C9; border: 1px solid #2569C9; border-radius: 10px; width: 330px; height: 330px; margin: auto; margin-top: 100px; margin-bottom: 100px;">
					<form name="frm" action="cvs_login" method="post">
						<h1 style="color: white;margin-bottom:25px;margin-top:50px">점주로그인</h1>
						<div style= height:30px;color:white;font-weight:bold>
							<span>아이디</span>&nbsp;&nbsp;&nbsp; <span><input type="text" name="cvs_id"  placeholder="점주코드 ex)A01" size=20;></span>
						</div>
						<div style= height:30px;color:white;font-weight:bold>
